...
def view_PDF(request, id=None):
    ...
    context = {
        "company": {
            "name": "Meer Security Services",
            "address" :"Head office: Office no.1, 1st Floor, Building 3-C, 22nd commercial street, Phase 2, DHA, Karachi, Pakistan.",
            "phone": "0301 8208337",
            "email": "meer@securityservices.com",
        },
